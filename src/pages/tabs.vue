...
<div class="hello">
	<header>
		...
		<div class="header-right">
			<router-link to="/tabs/my/setting" class="setting" :class="{show:currentIndex === 3}"><img src="../assets/my/icon_setting.svg" height="24" width="24" style="display:block;"></router-link>
		</div>
	</header>
	<div class="tab-panel">
